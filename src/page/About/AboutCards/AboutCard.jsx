...
const AboutCard = () => {
    return (
        <div className='text-black font-normal flex flex-col items-center md:items-start justify-center p-4 md:p-6 xl:w-[73rem] gap-4 tracking-wide rounded-lg'>
