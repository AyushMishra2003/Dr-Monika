    ...
    const policySection = [
        {
            ...
            content: (
                <div>
                    <p className="mb-4">By accessing and using the services provided by Dr. Monika's Medical Services (Sadbhavna Clinic), you agree to comply with and be bound by these Terms and Conditions. If you do not agree with any part of these terms, please do not use our services.</p>
        ...
        },
        {
            ...
            content: (
                <div>
                    ...
                    <ul className="list-disc pl-6 mb-4">
                        <li className="mb-2">Dr. Monika's Medical Services (Sadbhavna Clinic) and its healthcare professionals shall not be liable for any indirect, incidental, special, consequential, or punitive damages.</li>
        ...
        },
        {
            ...
            content: (
                <div>
                    <p className="mb-4">All content on our website and applications, including but not limited to text, graphics, logos, images, and software, is the property of Dr. Monika's Medical Services (Sadbhavna Clinic) and is protected by intellectual property laws.</p>
                    <ul className="list-disc pl-6 mb-4">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 mb-8">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            Welcome to Dr. Monika's Medical Services at Sadbhavna Clinic. These Terms and Conditions constitute a legally binding agreement between you and Dr. Monika's Medical Services regarding your use of our healthcare services, website, and other offerings.
                        </p>
